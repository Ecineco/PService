...
public class ProviderInfo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_providerinfo1);

        Bundle bundle = getIntent().getExtras();
        userId = bundle.getInt("userId");
        searchKey = bundle.getString("searchKey");

        save = findViewById(R.id.button31);
    ...
    Handler failHandler = new Handler(){
        ...
        public void handleMessage(Message msg){
            super.handleMessage(msg);
            AlertDialog.Builder builder = new AlertDialog.Builder(ProviderInfo1Activity.this);
            builder.setTitle("提示");
