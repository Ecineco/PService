...
public class PreListProActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prelistpro);

        Bundle bundle = getIntent().getExtras();
        userId = bundle.getInt("userId");
        listView = findViewById(R.id.prelist_p);
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try{
                    stmt = conn.prepareStatement("SELECT * FROM Preservation WHERE pid=?");
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent("com.ecin.pserviceii.PreDetailProActivity");
