...
public class ClientInfo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save = findViewById(R.id.button12);
    ...
    Handler failHandler = new Handler(){
        ...
        public void handleMessage(Message msg){
            super.handleMessage(msg);
            AlertDialog.Builder builder = new AlertDialog.Builder(ClientInfo1Activity.this);
            builder.setTitle("提示");
