...
public class ProviderInfo3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_providerinfo3);

        Bundle bundle = getIntent().getExtras();
        userId = bundle.getInt("userId");
        searchKey = bundle.getString("searchKey");

        save = findViewById(R.id.button36);
    ...
    Handler failHandler = new Handler(){
        ...
        public void handleMessage(Message msg){
            super.handleMessage(msg);
            AlertDialog.Builder builder = new AlertDialog.Builder(ProviderInfo3Activity.this);
            builder.setTitle("提示");
